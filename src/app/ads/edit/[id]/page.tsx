...
export default function EditAdPage({ params }: { params: Promise<{ id: string }> }) {
    ...
    if (loading) return <div className="p-8 text-white">Loading ad...</div>;
            ...
            <form onSubmit={handleSubmit} className="bg-dark-800 p-8 rounded-xl border border-white/5 space-y-6">
                ...
                <div className="flex gap-4">
                    <button
                        type="submit"
                        disabled={saving}
                        className="flex-1 py-4 bg-red-600 hover:bg-red-700 text-white font-bold rounded-xl transition-all shadow-lg shadow-red-900/30 disabled:opacity-50 flex items-center justify-center"
                    >
                        {saving ? (
